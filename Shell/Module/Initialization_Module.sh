...
IOTA_Node="$current_dir/Consensus/Shell/Node"
...
#actual app.
Consensus="$current_dir/Consensus" 
Node_Module=($(find $Consensus -name "Node_Module.sh")) > /dev/null 2>&1
